...
import GoodHot from './composiables/detail-hot.vue'
import ImageView from './composiables/imageView.vue'
import XtxSKu from '@/components/composiables/XtxSku/index.vue'
        ...
        <div>
          <div class="goods-info">
            ...
            <div class="spec">
              ...
              <!-- 数据组件 -->
              <el-input-number v-model="num" :min="1" :max="10" @change="handChange" />
              <!-- 按钮组件 -->
              <div>
          ...
          <div class="goods-footer">
            ...
            <div class="goods-aside">
              <!-- 24小时热榜 -->
              <GoodHot :type="1"> </GoodHot>
              <!-- 周热榜 -->
              <GoodHot :type="2"> </GoodHot>
            </div>
          </div>
        </div>
      </div>
